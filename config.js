...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? ' ••´º´•» ⧼M̼⧽⧼R̼⧽⧼.̼⧽⧼K̼⧽⧼A̼⧽⧼V̼⧽⧼E̼⧽⧼E̼⧽ «•´º´•• ' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '94703148103@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  𝒦𝒜𝒱𝐸𝐸  \n\n   wₕₐₜₛₐₚₚ ᵤₛₑᵣ bₒₜ   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? ' █▓▒­░⡷⠂පොම්ඩක් ඉම්න ⠐⢾░▒▓█ : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '█▓▒­░⡷⠂දැන් හරි වගෙයි⠐⢾░▒▓█ : process.env.SONGU,
    ...
    LIZA: process.env.LOGO_LINK === undefined ? 'https://ibb.co/Cb5nqQd' : process.env.LOGO_LINK,
    MWOL: process.env.BGM_DURATION === undefined ? '39999600' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? '𝙸'𝚖 𝚖𝚛.𝙺𝙰𝚅𝙴𝙴' : process.env.BOTV2_NAME,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '𝙸'𝚖 𝚖𝚛.𝙺𝙰𝚅𝙴𝙴' : process.env.LOGO_NAME,
    BRANCH: 'master',
    HEROKU: {
